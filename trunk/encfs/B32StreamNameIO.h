...
#ifndef _B32StreamNameIO_incl_
#define _B32StreamNameIO_incl_
...
class B32StreamNameIO : public NameIO
{
public:
    static rel::Interface CurrentInterface();

    B32StreamNameIO( const rel::Interface &iface,
	          const shared_ptr<Cipher> &cipher,
		  const CipherKey &key );
    virtual ~B32StreamNameIO();
