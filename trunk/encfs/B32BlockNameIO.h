...
#ifndef _B32BlockNameIO_incl_
#define _B32BlockNameIO_incl_
...
/*
    ...
    cipher block size.
*/
class B32BlockNameIO : public NameIO
{
public:
    static rel::Interface CurrentInterface();

    B32BlockNameIO( const rel::Interface &iface,
	         const boost::shared_ptr<Cipher> &cipher,
	         const CipherKey &key, int blockSize );
    virtual ~B32BlockNameIO();
